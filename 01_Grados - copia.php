...
<body class="d-flex align-items-center">
    ...
    <div id="contenidoAsistencia" class="container contenido hide">
        <h3 class="text-center mt-3"><i class="fas fa-arrow-left btnAtras boton"></i></h3>
            ...
            <div class="col-lg-4 col-md-4 col-sm-8 col-10  mx-auto">
                <div class="row">
                    <div id="expUno" class="col-6 boton d-flex align-items-center justify-content-center">
                        <div>
                            <i class="fas fa-file-excel "></i>&nbsp; <i id="expoOne" class="sinFormato" >Uno.</i> 
                        </div>                        
                    </div>
                    <div id="expAll" class="col-6 boton d-flex justify-content-center align-items-center" style="height: 40px;">
                        <div class="">
                            <i class="fas fa-copy"></i>&nbsp; <i id="expoAll" class="sinFormato" >Todos.</i>                            
                        </div>
                    </div>
                </div>
            </div>            
                ...
                <div class="modal-body">
                    ...
                    <div id="hi2" class="hide row my-3 d-flex justify-content-center align-items-center h-auto" >
                        ...
                        <div class=" col-auto cajaFoto me-1">
                            ...
                            <img id="imgRefEstudiante" class="videoC" src="img/asistencia/Usuario.png" alt="" srcset="">
                            <div class="row my-0">
                        ...
                        <div class=" col-auto cajaFoto">
                            ...
                            <img id="imgRespopnsable" class="videoC" src="img/asistencia/Usuario.png" alt="" srcset="">
                            <div class="row my-0">
    ...
    <script src="js/01_Grados.js"></script>
</body>
